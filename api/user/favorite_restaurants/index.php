<?php
    ...
    APIRoute(
        ...
        put: function() {
            ...
            if (!$success)
                APIError(HTTPStatusCode::INTERNAL_SERVER_ERROR, 'Error trying to favorite restaurant');
        ...
        delete: function() {
            ...
            if (!$success)
                APIError(HTTPStatusCode::INTERNAL_SERVER_ERROR, 'Error trying to unfavorite restaurant');
